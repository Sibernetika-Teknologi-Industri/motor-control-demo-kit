...
//  Serial.print("SETPOINT: "); Serial.println(integerValue); // print the incoming value for debugging
  motor_pwm_value = pidcontroller.compute(encoder_count);  //Let the PID compute the value, returns the calculated optimal output
//  Serial.print("pwm: "); Serial.print(motor_pwm_value); // print the calculated value for debugging
//  Serial.print("   enc: ");
